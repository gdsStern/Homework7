public class Main {
    public static void main(String[] args) {
        ...
        double ratio = (double) 17 / 8 / 1000;
        for (int years = 1; years <= 10; years++) {
            peoples = peoples + (int) (peoples * ratio);
        ...
        int month4 = 1;
        System.out.format("Месяц %s - кол-во накоплений: %.2f", month4, totalSavings);
        System.out.println("");
        do {
        ...
        int years = 9;
        int months = 12 * years;
        for (int month6 = 1; month6 <= months; month6++) {
